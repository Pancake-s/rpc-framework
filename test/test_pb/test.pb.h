...
constexpr User_Sex User_Sex_Sex_MAX = User_Sex_FEM;
...
inline void GetFriendListResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:test.GetFriendListResponse.result)
}
...
inline ::test::ResultCode* GetFriendListResponse::unsafe_arena_release_result() {
...
inline ::test::ResultCode* GetFriendListResponse::_internal_mutable_result() {
...
inline const ::test::User& GetFriendListResponse::_internal_friend_list(int index) const {
...
inline ::test::User* GetFriendListResponse::_internal_add_friend_list() {
